...
import com.crittermap.backcountrynavigator.xe.core.data.Database;
import com.crittermap.backcountrynavigator.xe.core.data.R;
...
public class Settings extends BaseModel implements Cloneable {
    ...
    @Column
    private COMPASS_STYLE compassStyle = COMPASS_STYLE.ORIENTEERING;
    @Column
    private COMPASS_SENSOR_TYPE compassSensorType = COMPASS_SENSOR_TYPE.ROTATION_VECTOR;
    @Column
    private THEME theme = THEME.DAY;
    @Column
    private int gpsSampleRate = 10;
    @Column
    ...
    public void importFromDTO(SettingsDTO settingsDTO) {
